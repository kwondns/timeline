...
import CodeFieldClient from '@/molecules/CodeField.client';
import EmailFieldClient from '@/molecules/EmailField.client';
import NameFieldClient from '@/molecules/NameField.client';
import PasswordFieldClient from '@/molecules/PasswordField.client';
    ...
    <Container direction="column">
      ...
      <FieldContainer trigger={isValidated}>
        <Container direction="column" className="mt-6 w-full">
          ...
          />
          <NameFieldClient onChange={setName} action={run} />
        </Container>
      </FieldContainer>
